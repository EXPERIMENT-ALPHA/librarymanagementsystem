...
RUN wget https://dlcdn.apache.org/tomcat/tomcat-8/v8.5.88/bin/apache-tomcat-8.5.88.tar.gz

RUN tar -zxvf OpenJDK8U-jdk_x64_linux_hotspot_8u372b07.tar.gz
RUN tar -zxvf apache-tomcat-8.5.88.tar.gz

RUN rm -rf OpenJDK8U-jdk_x64_linux_hotspot_8u372b07.tar.gz
RUN rm -rf apache-tomcat-8.5.88.tar.gz

RUN mv apache-tomcat-8.5.88 tomcat
